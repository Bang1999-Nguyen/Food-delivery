  ...
  function renderMainCategories() {
    ...
    return (
      <View style={{ padding: SIZES.padding * 2 }}>
        <Text style={{ fontWeight: "bold", fontSize: "20px" }}>Main</Text>
        <Text style={{ fontWeight: "bold", fontSize: "20px" }}>Categories</Text>
        <FlatList
          data={categories}
          horizontal
          ...
          contentConatinerStyle={{ paddingVertical: SIZES.padding * 2 }}
        />
      </View>
    );
  }
